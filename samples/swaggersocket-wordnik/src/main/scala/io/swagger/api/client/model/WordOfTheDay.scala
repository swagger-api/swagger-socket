...
class WordOfTheDay extends Object {
	...
	def getDefinitions:java.util.List[io.swagger.api.client.model.Definition] = {
	    definitions.toList
	}
	def setDefinitions(args:java.util.List[io.swagger.api.client.model.Definition]) = {
	    definitions.clear
	...
	def getExamples:java.util.List[io.swagger.api.client.model.Example] = {
	    examples.toList
	}
	def setExamples(args:java.util.List[io.swagger.api.client.model.Example]) = {
	    examples.clear
